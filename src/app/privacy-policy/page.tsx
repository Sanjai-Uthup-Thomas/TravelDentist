    ...
    <div className="relative min-h-screen bg-gradient-to-b from-[#fff0f5] to-white text-gray-900">
      ...
      >
        ...
        <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
          <p>
            At travel dentist, we value your privacy. This Privacy Policy
          ...
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>
              Health-related information voluntarily provided during appointment
              bookings or consultations
            </li>
            <li>
              Usage data such as IP address, browser type, and access time
            </li>
          </ul>
          ...
          <p>
            ...
            share data with trusted partners who assist in operating our website
            or conducting our business — all of whom are required to maintain
            confidentiality.
          </p>
          ...
          <p>
            ...
            about you, request corrections, or ask for its deletion under
            applicable laws.
          </p>
