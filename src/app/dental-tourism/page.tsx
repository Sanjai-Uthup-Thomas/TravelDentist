  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#fff1f2] to-white text-gray-900">
      ...
      >
        ...
        >
          <p>
            With the healthcare costs increasing rapidly in developed countries,
            dental treatment has become a costly affair. Patients in developed
            nations are increasingly looking forward to treatment options in
            countries like India which offer similar or even better dental
            services at much more affordable rates — along with the opportunity
        ...
        <motion.section
          ...
          className="space-y-6 mb-12"
        >
          <h2 className="text-3xl font-semibold text-[#F875AA]">
            Kerala - God&apos;s Own Country
          </h2>
          <p>
            Our dental office is set up in a picturesque part of Kerala called
            Kottayam. From there, you can explore hilly terrains, exotic
            wildlife, stunning waterfalls, serene streams in the hills of
            Idukki, and the beautiful backwaters of Kumarakom.
          </p>
          <p>
            We offer great staycations promoting sustainable, ecologically
            friendly, and locally oriented tourism.
          </p>
        </motion.section>
        ...
        <motion.section
          ...
          transition={{ duration: 0.5 }}
        >
          <h2 className="text-3xl font-semibold text-[#F875AA] mb-6">
            Places to Explore
          </h2>
            ...
            {[
              ...
              >
                ...
                <div className="p-4 bg-white">
                  <h3 className="text-xl font-semibold text-[#F875AA] text-center">
                    {place.name}
                  </h3>
                </div>
              </motion.div>
        ...
        >
          <p className="text-2xl font-semibold mb-4 text-pink-900">
            Interested in exploring Kerala while taking care of your dental
            health?
          </p>
