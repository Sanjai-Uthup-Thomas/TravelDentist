        ...
        <div className="max-w-4xl mx-auto flex flex-col-reverse md:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              ...
              in Periodontology and Implantology. Dr. Rahul Joseph has undergone
              extensive training in conventional implants by
              <span className="text-pink-600 font-semibold">
                {" "}
                Dentium, South Korea
              </span>
              . He brings precision and excellence in gum treatment and
              implantology with a compassionate approach.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              ...
              in Prosthodontics and Implantology. He holds a Fellowship in Oral
              Implantology from
              <span className="text-pink-600 font-semibold">
                {" "}
                FBOCI, Sweden
              ...
              . Additionally, he is highly skilled in pterygoid implants and the
