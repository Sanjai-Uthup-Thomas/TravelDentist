      ...
      >
        ...
        >
          <p className="text-lg leading-relaxed">
            Laser dentistry uses focused light beams to remove or shape tissue
            with unmatched precision. It reduces discomfort, speeds healing, and
            sterilizes treatment areas to lower infection risk — perfect for
            modern dental care.
          </p>

          {/* Advantages */}
          <div className="bg-pink-50 p-6 rounded-xl shadow-md border-l-4 border-[#F875AA]">
            <h2 className="text-2xl font-semibold text-[#F875AA] mb-3">
          ...
          <p className="text-lg leading-relaxed">
            We use a high-tech 10W 980nm diode laser — the gold standard for
        ...
        >
          ...
          <p className="text-lg mb-6 text-gray-800">
            Discover the benefits of laser treatment. Let’s make your next
            dental visit calm and comfortable.
          </p>
